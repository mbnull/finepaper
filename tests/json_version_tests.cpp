...
int main(int argc, char** argv) {
    ...
    QJsonObject v3Json = v2Json;
    v3Json.insert(QStringLiteral("formatVersion"), 3);
    const DesignLoadResult v3Result = designFromJson(v3Json);
    check(!v3Result.success
              && hasDiagnostic(v3Result.diagnostics,
                               QStringLiteral("design.unsupported_version"),
                               QStringLiteral("/formatVersion")),
          QStringLiteral("formatVersion 3 is rejected"));
