...
target("qt")
    ...
    add_files("inc/**/designeditingservice.h")
...
target("noc_contract_schema_meta_test")
    ...
    add_files("test/noc_contract_schema_meta_test.cpp")
    add_tests("default", {
        trim_output = true,
...
add_qt_test_target("validation_test", "test/validation_test.cpp", {
    ...
    "src/ipcore/ipcoregraphexporter.cpp",
    "src/ipcore/ipcatalogservice.cpp",
    "test/support/legacy_drc/drcrunner.cpp",
    ...
    "inc/**/graph.h",
    "inc/**/module.h",
    "test/support/legacy_drc/drcrunner.h",
    ...
    "inc/ipcraft/ipcraftmanifest.h",
    "inc/ipcraft/ipcraftmanifestreader.h",
    "inc/ipcraft/ipcraftregistry.h",
...
add_qt_test_target("vendor_meshnoc_onboarding_test", "test/vendor_meshnoc_onboarding_test.cpp", {
...
target("packageplugin_test")
    ...
    add_files("inc/package/packageservice.h")
    add_tests("default", {
        trim_output = true,
...
add_qt_test_target("staticplugincatalog_test", "test/staticplugincatalog_test.cpp", {
    "src/app/serviceregistry.cpp",
    "src/app/extensionpointregistry.cpp",
    "src/app/capabilityregistry.cpp",
    "src/app/plugininteractionregistry.cpp",
...
target("plugin_architecture_phase3_scan_test")
    add_rules("qt.console")
    set_kind("binary")
    set_group("test")
    set_default(false)
    ...
    add_includedirs("inc")
    add_files("test/plugin_architecture_phase3_scan_test.cpp")
    add_tests("default", {
        trim_output = true,
        pass_outputs = "plugin_architecture_phase3_scan_test passed"
    })

target("plugin_architecture_phase4_scan_test")
    add_rules("qt.console")
    set_kind("binary")
    set_group("test")
    set_default(false)
    ...
    add_includedirs("inc")
    add_files("test/plugin_architecture_phase4_scan_test.cpp")
    add_tests("default", {
        trim_output = true,
        pass_outputs = "plugin_architecture_phase4_scan_test passed"
    })

target("plugin_architecture_phase5_scan_test")
    add_rules("qt.console")
    set_kind("binary")
    set_group("test")
    set_default(false)
    ...
    add_includedirs("inc")
    add_files("test/plugin_architecture_phase5_scan_test.cpp")
    add_tests("default", {
        trim_output = true,
...
target("plugin_architecture_phase7_scan_test")
    add_rules("qt.console")
    set_kind("binary")
    set_group("test")
    set_default(false)
    ...
    add_includedirs("inc")
    add_files("test/plugin_architecture_phase7_scan_test.cpp")
    add_tests("default", {
        trim_output = true,
        pass_outputs = "plugin_architecture_phase7_scan_test passed"
    })

target("plugin_architecture_phase8_scan_test")
    add_rules("qt.console")
    set_kind("binary")
    set_group("test")
    set_default(false)
    ...
    add_includedirs("inc")
    add_files("test/plugin_architecture_phase8_scan_test.cpp")
    add_tests("default", {
        trim_output = true,
        pass_outputs = "plugin_architecture_phase8_scan_test passed"
    })

target("plugin_architecture_phase9_scan_test")
    add_rules("qt.console")
    set_kind("binary")
    set_group("test")
    set_default(false)
    ...
    add_includedirs("inc")
    add_files("test/plugin_architecture_phase9_scan_test.cpp")
    add_tests("default", {
        trim_output = true,
        pass_outputs = "plugin_architecture_phase9_scan_test passed"
    })

target("plugin_architecture_phase10_scan_test")
    add_rules("qt.console")
    set_kind("binary")
    set_group("test")
    set_default(false)
    ...
    add_includedirs("inc")
    add_files("test/plugin_architecture_phase10_scan_test.cpp")
    add_tests("default", {
        trim_output = true,
        pass_outputs = "plugin_architecture_phase10_scan_test passed"
    })

target("plugin_hard_cutover_scan_test")
    add_rules("qt.console")
    set_kind("binary")
    set_group("test")
    set_default(false)
    ...
    add_includedirs("inc")
    add_files("test/plugin_hard_cutover_scan_test.cpp")
    add_tests("default", {
        trim_output = true,
        pass_outputs = "plugin_hard_cutover_scan_test passed"
    })
...
target("ipcatalogpanel_test")
    ...
    add_files("src/app/topologypresetinteractionhandler.cpp")
    add_files("src/noc/nocplugin.cpp")
    ...
    add_files("inc/**/projectservice.h")
    add_files("inc/**/designeditingservice.h")
    add_files("inc/**/packageservice.h")
    add_files("inc/**/activeworkspacecontroller.h")
    add_files("inc/**/validationmanager.h")
    add_tests("default", {
        trim_output = true,
...
target("nodeeditor_geometry_test")
    ...
    add_files("src/ipcraft/core/project_patch.cpp")
    add_files("src/ipcore/ipcatalogservice.cpp")
    add_files("src/project/designeditingservice.cpp")
