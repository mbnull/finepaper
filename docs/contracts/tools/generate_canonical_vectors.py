...
def applicability() -> dict[str, Any]:
    return {
        ...
        'structureAuthority': {'kind': 'default-engine', 'lockId': 'dep.engine', 'identity': 'engine.mesh', 'version': '1', 'bundleDigest': DIGEST_A},
...
def base_candidate() -> dict[str, Any]:
    return {
        ...
        'authorityPatch': {'patchId': 'patch.authority', 'source': {'kind': 'default-engine', 'identity': 'engine.mesh', 'version': '1', 'bundleDigest': DIGEST_A}, 'operations': [router_create()]},
