...
- `vectors/rfc8785-conformance-v1.json` records numeric, UTF-16 property-order, duplicate-key, surrogate, and binary64 admission vectors.
- `error-codes-v1.json` is the machine-readable stable Core/runtime error catalog for Revision 5.
...
Revision 4 was unfrozen for the Revision 5 canonicalization and validation
correction recorded in `UNFREEZE-REV4-ADR.md`. Revision 5 is the frozen public
Core contract; `CORE-FREEZE.md` is the authoritative status and archive record.

## Revision 5 freeze input set
