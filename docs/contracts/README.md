...
- `patch-validation-context-v1.json` freezes the deterministic Patch current-state, complete reconcile applicability, dependency locks, closed Host side effects, ordinary trusted Patch digests, and formal topology/migration history replay records at `sha256:8f7c03e73dc634220222442202b9cb7650c7251fd2edca69deb976230e3fa9a2` for standalone precondition, ownership, reference, lifecycle, and transaction fixtures.
